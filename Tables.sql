...
-- Link to schema: https://app.quickdatabasediagrams.com/#/d/777aqv
...
CREATE TABLE `recipe` (
    `row_id` int  NOT NULL ,
    `reciepe_id` varchar(20)  NOT NULL ,
...
ALTER TABLE `recipe` ADD CONSTRAINT `fk_recipe_reciepe_id` FOREIGN KEY(`reciepe_id`)
REFERENCES `item` (`sku`);
